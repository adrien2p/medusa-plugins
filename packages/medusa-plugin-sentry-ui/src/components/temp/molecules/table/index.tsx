				...
				<div className="w-full flex justify-between mb-2">
					{filteringOptions ? (
						<div className="flex mb-2 self-end">
							{Array.isArray(filteringOptions) ? 'Not supported' : filteringOptions}
						</div>
					) : (
						<span aria-hidden />
					)}
...
export const TablePagination = ({
	...
	return (
		<div className={clsx('flex w-full justify-between inter-small-regular text-grey-50 mt-14', className)}>
