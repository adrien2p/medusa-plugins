...
import {KEYCLOAK_ADMIN_STRATEGY_NAME, KEYCLOAK_STORE_STRATEGY_NAME, KeycloakOptions} from "../auth-strategies/keycloak";
...
export const strategyNames: StrategyNames = {
  ...
  keycloak: {
    admin: KEYCLOAK_ADMIN_STRATEGY_NAME,
    store: KEYCLOAK_STORE_STRATEGY_NAME,
  }
};
